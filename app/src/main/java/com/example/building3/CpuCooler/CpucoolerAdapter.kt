...
class CpucoolerAdapter(private val cpucoolerList: List<CPUCOOLER>) : RecyclerView.Adapter<CpucoolerAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            openUrlInApp(holder.itemView.context, cpucooler.url)
        }
    }

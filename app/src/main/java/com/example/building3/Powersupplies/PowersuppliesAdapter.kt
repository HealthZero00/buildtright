...
class PowersuppliesAdapter(private val powersuppliesList: List<POWERSUPPLIES>) : RecyclerView.Adapter<PowersuppliesAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            openUrlInApp(holder.itemView.context, powersupply.url)
        }
    }
